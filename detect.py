...
def detect(dataset, model, num_classes=21, mapping=Traffic_idx2name):
    ...
    for idx in range(dataset.__len__()):
        ...
        #featuring(pred_bboxes, origin_image)
...
if __name__ == "__main__":
    pretrain_path = r"/home/manh/checkpoint/iteration_8000.pth"
    
    dataset, model, num_classes, mapping = detect_on_Traffic(pretrain_path=pretrain_path, version="original", size=300)
    model.eval()
